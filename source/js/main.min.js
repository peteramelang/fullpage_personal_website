...
/**
 * articleManager 0.0.1
 * https://github.com/peteramelang/fullPage.js
 * MIT licensed
 *
 * Copyright (C) 2015 peteramelang.net
 */

(function(){

	// save name of loaded articles in this array
	var loadedArticle = [];
	...
	$( document ).ready(function() {
		...
		// if selected article is already loaded (=> NOT NEW: false): init article
		if(jQuery.inArray(selectedArticle, loadedArticle)!==-1){
			initArticle(selectedArticle, false);
		}
		// if it's not loaded: load article and then init it (=> NEW: true)
		// + push name of the article-file to the array of the loaded files
		else {
